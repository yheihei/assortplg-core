...
class MailService
{
    ...
    //yhei
    /**
     * Send order Assort mail.
     *
     * @param \Eccube\Entity\Order $Order 受注情報
     * @return string
     */
    public function sendOrderAssortMail(\Eccube\Entity\Order $Order, $AssortCartItems)
    {
        log_info('アソート商品受注メール送信開始');
        ...
        $body = $this->app->renderView($MailTemplate->getFileName(), array(
            ...
            'footer' => $MailTemplate->getFooter(),
            'Order' => $Order,
            'AssortCartItems' => $AssortCartItems,
        ));
